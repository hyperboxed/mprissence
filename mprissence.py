...
def main():
    ...
    # keep track of the last time we successfully sent data to Discord
        ...
        try:
            ...
            if status == 'Playing':
                ...
                if title != last_track:
                    ...
                    # 3. last resort: upload local/data
                    ...
                    last_rpc_update_time = time.time()
                ...
                # ---> SAME TRACK
                    ...
                    # heartbeat: checking for "pulse"
                    # force an update every 15 seconds to ensure connection health
                    # so, if Discord is unavailable, this call will eventually raise an exception
                    elif time.time() - last_rpc_update_time > 15:
                        should_update = True
